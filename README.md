...
**Не знаете какую модель выбрать?** Читайте подробный гайд: **[MODELS_GUIDE.md](MODELS_GUIDE.md)**

**Быстрая рекомендация:**
- 🥇 **Mistral 7B** - лучший универсал (8GB RAM)
- 💻 **Code Llama** - для программирования (8GB RAM)
- ⚡ **Phi-2** - для слабых ПК (4-6GB RAM)
